...
const PATH = '/Indicadores/v3_indicador_vendedor';
...
describe('Indicadores - GET /Indicadores/v3_indicador_vendedor', { env: { hideCredendials: true } } , () => {

  it('Status Code is 200', () => {
    cy.api({
      method: 'GET', 
      url: `${BASE_URL}/${PATH}/${ano}/${mes}/${dia}`, 
