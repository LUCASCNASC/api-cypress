...
const PATH = '/Fisco/Contabil/v3_validar_documento_diverso_entrada_incluir';
const Authorization = Cypress.env('API.PRAGMA');

describe('Fisco/Contábil - POST /Fisco/Contabil/v3_validar_documento_diverso_entrada_incluir', { env: { hideCredendials: true } }, () => {
