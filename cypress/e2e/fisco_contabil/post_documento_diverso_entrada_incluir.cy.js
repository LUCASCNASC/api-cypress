...
const PATH = '/Fisco/Contabil/v3_post_documento_diverso_entrada_incluir';
const Authorization = Cypress.env('API.PRAGMA');

describe('API rest - Fisco/Contábil - POST - /Fisco/Contabil/v3_post_documento_diverso_entrada_incluir', { env: { hideCredendials: true } }, () => {
