...
const PATH = '/Fisco/Contabil/v3_post_receber_transferencia';
const Authorization = Cypress.env('API.PRAGMA');

describe('API rest - Fisco/Contábil - POST /Fisco/Contabil/v3_post_receber_transferencia', { env: { hideCredendials: true } }, () => {
