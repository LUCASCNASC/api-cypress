...
describe('API rest - Fisco/Contábil - POST - /v3/documento_outras_receitas_incluir', { env: { hideCredendials: true } }, () => {
  
  it('Status Code 200 e as propriedades do documento de outras receitas incluído', () => {
