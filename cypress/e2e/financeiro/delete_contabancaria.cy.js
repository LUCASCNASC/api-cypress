...
describe('API rest - Financeiro - DELETE /v3/contabancaria/{codigoBanco}/{codigoAgencia}/{codigoConta}', { env: { hideCredentials: true } }, () => {

  it('Status Code 200 ao excluir conta bancária', () => {
    cy.api({
      method: 'DELETE',
