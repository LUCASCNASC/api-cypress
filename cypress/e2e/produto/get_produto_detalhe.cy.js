...
const PATH = '/Produto/v2_produto_detalhe';
...
describe('Produto - GET - /Produto/v2_produto_detalhe', { env: { hideCredendials: true } }, () => {
  
  it('Status Code is 200', () => {
    cy.api({
      method: 'GET', 
      url: `${BASE_URL}/${PATH}/${produto}/${pesquisagtin}/${pedido}`, 
