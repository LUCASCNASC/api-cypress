...
const PATH = '/Logística/v3_get_logistica_lista_mapa_carga_loja_lote';
...
describe('Logística - GET - /Logística/v3_get_logistica_lista_mapa_carga_loja_lote', { env: { hideCredendials: true } }, () => {
