...
const PATH = '/Logística/v3_get_logistica_lista_mapa_carga_loja';
...
describe('API rest - Logística - GET - /Logística/v3_get_logistica_lista_mapa_carga_loja', { env: { hideCredendials: true } } , () => {
