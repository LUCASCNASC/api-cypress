...
const PATH = '/Logística/v3_post_mapa_carga_acarregar_itens';
const Authorization = Cypress.env('API.PRAGMA');

describe('API rest - Logística - POST - /Logística/v3_post_mapa_carga_acarregar_itens', { env: { hideCredendials: true } }, () => {
