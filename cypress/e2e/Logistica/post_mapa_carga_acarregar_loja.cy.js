...
const PATH = '/Logística/v3_post_mapa_carga_acarregar_loja';
const Authorization = Cypress.env('API.PRAGMA');

describe('API rest - Logística - POST - /Logística/v3_post_mapa_carga_acarregar_loja', { env: { hideCredendials: true } }, () => {
