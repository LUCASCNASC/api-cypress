...
const PATH = '/Logística/v3_post_mapa_carga_acarregar_cliente';
const Authorization = Cypress.env('API.PRAGMA');

describe('API rest - Logística - POST - /Logística/v3_post_mapa_carga_acarregar_cliente', { env: { hideCredendials: true } }, () => {
